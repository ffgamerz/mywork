# Graph Report - /Users/azmanrazali/web/mywork  (2026-07-28)

## Corpus Check
- cluster-only mode — file stats not available

## Summary
- 85 nodes · 131 edges · 9 communities (8 shown, 1 thin omitted)
...
## Knowledge Gaps
- **26 isolated node(s):** `name`, `private`, `version`, `type`, `dev` (+21 more)
